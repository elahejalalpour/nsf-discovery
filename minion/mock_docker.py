...
class Client:
    ...
    def inspect_container(self,container=None):
        if(container in 'd998116c32849114eae8152c060fcd4cc12989e9b3a1c71e6172d42fa43a9331' or
            ...
            data = {
                ...
                True, 'FinishedAt': '0001-01-01T00:00:00Z',
                'Restarting': False,
                'Error': '', 'StartedAt':
                '2016-07-27T17:13:48.887176507Z',
                'ExitCode': 0
        }, 'Config': {
            'Tty': False, 'Cmd': ['/bin/bash',
                    '-c', 'ufw enable && ufw allow ssh && /usr/sbin/sshd -D'
                ], 'Volumes': None, 'Domainname':
                '', 'WorkingDir': '',
                'Image': 'firewall',
                'Hostname': 'd998116c3284',
                'StdinOnce': False, 'Labels': {},
                'AttachStdin': False,
                'User': '', 'Env': [
        ...
        'Args': ['-c', 'ufw enable && ufw allow ssh && /usr/sbin/sshd -D'],
        'Driver': 'aufs', 'Path':
        '/bin/bash', 'HostnamePath':
        '/var/lib/docker/containers/d998116c32849114eae8152c060fcd4cc12989e9b3a1c71e6172d42fa43a9331/hostname',
        'RestartCount': 0, 'Name':
        '/nfuser-new-firewall', 'Created':
        '2016-07-27T17:13:18.481285259Z',
        'GraphDriver': {
            'Data': None, 'Name': 'aufs'
        }, 'Mounts': [], 'ProcessLabel':
        '', 'NetworkSettings': {
            'Bridge': '', 'Networks': {
                    'bridge': {
                            'NetworkID':
                            'b4a39361e286a51c5a4329cb9fb5b899b19512ffe1fb7c5a9f7421cb62cb5431',
                            'MacAddress':
                            '02:42:ac:11:00:02',
                            'GlobalIPv6PrefixLen':
                            0, 'Links':
                            None, 'GlobalIPv6Address':
                            '', 'IPv6Gateway':
                            '', 'IPAMConfig':
                            None, 'EndpointID':
                            '1fbd43b6a9320e4e76e1b2d16e667ff3298ddef2c3312449869f7a50a61b30f1',
                ...
                None, 'LinkLocalIPv6Address':
                '', 'HairpinMode':
                False, 'IPv6Gateway':
                '', 'SecondaryIPAddresses':
                None, 'SandboxID': '31ffa1d10bd725037ea4384d7be7f458e54ae82300e6384268754a72ee930dd0',
                'MacAddress': '02:42:ac:11:00:02',
                'GlobalIPv6Address':
                '', 'Gateway': '172.17.0.1',
                'LinkLocalIPv6PrefixLen':
                0, 'EndpointID': '1fbd43b6a9320e4e76e1b2d16e667ff3298ddef2c3312449869f7a50a61b30f1',
        ...
        }, 'AppArmorProfile': '', 'Image':
        'sha256:5fbc7e938c30d5919179a68718f19ab800f8e7dc7eddde995f11a83aebd396de',
        ...
        'HostConfig': {
            'CpuPeriod': 0, 'MemorySwappiness':
                -1, 'ContainerIDFile':
                '', 'KernelMemory':
                0, 'BlkioBps': 0, 'Memory':
                0, 'CpuQuota': 0, 'UsernsMode':
                '', 'StorageOpt':
                None, 'AutoRemove':
                False, 'BlkioDeviceReadIOps':
                None, 'Dns': None, 'ExtraHosts':
                None, 'SandboxSize':
                0, 'PidsLimit': 0, 'DnsSearch':
                None, 'Privileged':
                True, 'CpuPercent': 0,
                'Ulimits': None, 'CpusetCpus':
                '', 'DiskQuota': 0,
                'CgroupParent': '',
                'BlkioWeight': 0, 'RestartPolicy': {
                        'MaximumRetryCount':
                        0, 'Name': ''
                }, 'OomScoreAdj': 0,
                'BlkioDeviceReadBps':
                ...
                'BlkioDeviceWriteBps':
                None, 'Isolation': '',
                'GroupAdd': None, 'Devices':
                None, 'BlkioDeviceWriteIOps':
                None, 'Binds': None,
                'CpusetMems': '', 'Cgroup':
                '', 'UTSMode': '',
                'PidMode': '', 'VolumesFrom':
                None, 'CapDrop': None,
                'DnsOptions': None, 'ShmSize':
                67108864, 'Links':
                None, 'BlkioIOps': 0,
                'IpcMode': '', 'PortBindings':
                None, 'SecurityOpt':
                None, 'CapAdd': None,
                'CpuCount': 0, 'MemorySwap':
                0, 'OomKillDisable':
                False, 'LogConfig': {
                    'Config': {}, 'Type':
                        'json-file'
        ...
        'MountLabel': ''
            ...
            'Status': 'exited', 'Pid':
                ...
                False, 'Running':
                False, 'FinishedAt':
                '2016-07-26T16:45:34.225962598Z',
                'Restarting': False,
                'Error': '', 'StartedAt':
                '2016-07-26T16:45:01.117915909Z',
                'ExitCode': 137
        }, 'Config': {
            'Tty': False, 'Cmd': ['/bin/bash',
                    '-c', 'ufw enable && ufw allow ssh && /usr/sbin/sshd -D'
        ...
        'Driver': 'aufs', 'Path':
        '/bin/bash', 'HostnamePath':
        '/var/lib/docker/containers/f5b716c6d757e97cdd2e2df2a7b37f357b946916787d681e8b29c62e0daa811e/hostname',
        'RestartCount': 0, 'Name':
        '/nfuser-edge-ufw-1', 'Created':
        '2016-05-12T17:53:13.846817415Z',
        'GraphDriver': {
            'Data': None, 'Name': 'aufs'
        }, 'Mounts': [], 'ProcessLabel':
        '', 'NetworkSettings': {
            'Bridge': '', 'Networks': {
                    'bridge': {
                            'NetworkID':
                            '327bcdea10c03bdd18fe4df73fc13b79992f12750ff0954d3aa13468b851b653',
                            'MacAddress':
                            '', 'GlobalIPv6PrefixLen':
                            0, 'Links':
                            None, 'GlobalIPv6Address':
                ...
                False, 'IPv6Gateway':
                '', 'SecondaryIPAddresses':
                None, 'SandboxID': 'ba9ae97d4cea1bb32595e7163b518572a24677331688cb9656af2d26ff9b0829',
        ...
        'HostConfig': {
            'CpuPeriod': 0, 'MemorySwappiness':
                ...
                False, 'BlkioDeviceReadIOps':
                None, 'Dns': ['8.8.8.8'],
                'ExtraHosts': None, 'SandboxSize':
                0, 'PidsLimit': 0, 'DnsSearch': [],
                'Privileged': True, 'CpuPercent':
                0, 'Ulimits': None, 'CpusetCpus':
                '', 'DiskQuota': 0,
                'CgroupParent': '',
                'BlkioWeight': 0, 'RestartPolicy': {
                        'MaximumRetryCount':
    ...
    def images(self):
        data = [{
            ...
            'Created': 1453830514, 'Labels':
                None, 'VirtualSize':
                131274281, 'ParentId': 'sha256:3e340441a556b66e2b0b93b84564ee06026574c5ce6c04eade306ee06e64919c',
                'RepoTags': ['ubuntu:15.04'],
                'RepoDigests': None, 'Id':
                'sha256:d1b55fd07600b2e26d667434f414beee12b0771dfd4a2c7b5ed6f2fc9e683b43',
                'Size': 131274281
        }, {
            'Created': 1453246284, 'Labels':
                None, 'VirtualSize':
                187899635, 'ParentId': 'sha256:039f1bb3922f20162d1f2e43dc308a21fb975eed0990f31fedd0cc19b4e335ab',
                'RepoTags': ['ubuntu:latest'],
                'RepoDigests': None, 'Id':
                'sha256:3876b81b5a81678926c601cd842040a69eb0456d295cd395e7a895a416cf7d91',
                'Size': 187899635
        }]
        return data
